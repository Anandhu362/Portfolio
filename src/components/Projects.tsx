...
const projects: Project[] = [
    { id: 1, title: 'RR Business Group', description: 'Modern React-based business website for Dubai-based company', image: '/rr.png', tags: ['React', 'Business', 'Freelance', 'Web'], techStack: ['React', 'TypeScript', 'Tailwind CSS', 'Framer Motion'], fullDescription: 'A professional business website for RR Business Group, a Dubai-based company. Features modern design, smooth animations, and comprehensive business info with multilingual support.', features: ['Responsive design', 'Smooth animations', 'Multilingual support', 'SEO optimized'], githubUrl: 'https://github.com/Anandhu362/RrBusinessGroup', liveUrl: '#', category: 'Web' },
